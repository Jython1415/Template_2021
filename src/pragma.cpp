...
Motor left_back   ( "left back"    , vex::PORT9  , false   , 1          , false , false    , false   , true    , false , false );
Motor right_front ( "right front"  , vex::PORT5  , false   , 2          , false , false    , false   , true    , false , false );
Motor right_back  ( "right back"   , vex::PORT8  , true    , 3          , false , false    , false   , true    , false , false );
